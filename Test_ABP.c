...
static uint8_t data[] = "Hell of a World  ";
...
static void initfunc(osjob_t * j) {
  ...
  if  (LMIC.opmode & OP_TXRXPEND){
   ...
   // Check what should the 1st argument of thelast function be
        LMIC_setSession(0x010203, 0x260113BD, nwkskey, appskey); //check device address
        LMIC_setTxData2(1, data, sizeof(data), LORAWAN_CONFIRMED_MSG_ON);
        fprintf(stdout, "LMIC frame has been sent ! \n");
  }
    *
